...
if __name__ == "__main__":
    ...
    for sector_idx in tqdm(sector_lst, total=len(sector_lst), desc="Processing training and prediction"):
        try:
            ...
            gs = GridSearchCV(
                estimator=RidgeClassifier(solver="svd"),
            ...
            # gs = GridSearchCV(
            #     estimator=LogisticRegression(penalty='l1', solver='saga', warm_start=True, max_iter=100, tol=1e-3),
            #     param_grid=param_grid,
            #     cv=5,
            #     scoring="f1",
            #     n_jobs=-1,
