...
input_path = f"./datasets/{input_prefix}_w{time_window}_o{order}_d{dimension}.parquet"

# Fixed number of clusters
optimal_k = 10

# Output paths
clustered_data_path = f"./datasets/{input_prefix}_w{time_window}_o{order}_d{dimension}_clusters.parquet"
# model_path = f"./datasets/{input_prefix}_w{time_window}_o{order}_d{dimension}_kmeans_final.joblib"
# stock_list_path = f"./datasets/{input_prefix}_w{time_window}_o{order}_d{dimension}_all_stock_ids.joblib"
# centroids_path = f"./datasets/{input_prefix}_w{time_window}_o{order}_d{dimension}_cluster_centroids.joblib"
# distance_matrix_path = f"./datasets/{input_prefix}_w{time_window}_o{order}_d{dimension}_avg_distance_32.npy"
